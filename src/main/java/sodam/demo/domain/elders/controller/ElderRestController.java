package sodam.demo.domain.elders.controller;
...
import sodam.demo.domain.elders.service.ElderQueryService;
...
public class ElderRestController {
    ...
    public ApiResponse<ElderResponseDto.ElderHomeResponseDto> getElderHomeInfo(@PathVariable Long elderId){
            return ApiResponse.onSuccess(elderQueryService.getElderHomeInfo(elderId));
    }
}
